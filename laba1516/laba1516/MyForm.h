...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(451, 286);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Verdana", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label1->Location = System::Drawing::Point(271, 10);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(273, 18);
			this->label1->TabIndex = 1;
			this->label1->Text = L"Расчитать стоимость поездки";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Verdana", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(51, 111);
			this->label2->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(288, 18);
			this->label2->TabIndex = 2;
			this->label2->Text = L"Введите цену за литр бензина:";
			// 
			// label3
			// 
			...
			this->label3->Size = System::Drawing::Size(430, 18);
			this->label3->TabIndex = 3;
			this->label3->Text = L"Введите количество пройденных километров: ";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(491, 109);
			this->textBox1->Margin = System::Windows::Forms::Padding(4, 3, 4, 3);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(206, 27);
			this->textBox1->TabIndex = 4;
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(491, 156);
			this->textBox2->Margin = System::Windows::Forms::Padding(4, 3, 4, 3);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(206, 27);
			...
			this->label4->Size = System::Drawing::Size(374, 18);
			this->label4->TabIndex = 6;
			this->label4->Text = L"Введите расход бензина на 100 км пути:";
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(491, 209);
			this->textBox3->Margin = System::Windows::Forms::Padding(4, 3, 4, 3);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(206, 27);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label5->Location = System::Drawing::Point(51, 301);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		double S = System::Convert::ToDouble(textBox2->Text);
		double b = System::Convert::ToDouble(textBox3->Text);
		itog = S / 100 * b * a;
		label5->Text = "Стоимость поездки: " + System::Convert::ToString(itog) + " Руб";
	}
};
}
